% zscores each image so that within-image the mean value is zero and
% variance is 1
classdef zscoreImageTransformer < fmriDataTransformer
    ...
    methods
        function obj = zscoreImageTransformer(batch_id_funhan)            
        ...
        function dat = transform(obj, dat)
            ...
            for i = 1:n_batch_id
                ...
                dat.dat(:,this_idx) = zscore(dat.dat(:, this_idx)); % zscore columns
            end
        end
    end
end